...
knitr::opts_chunk$set(fig.width=8, fig.height=6, fig.align = 'center',
                      ...
                      dev = c("png", "cairo_pdf"),
                      fig.path = "../figure/",
                      # remove knitr figure numbering 
                      # (ex. chunk_name-1.pdf -> chunk_name.pdf)
...
```{r scores_by_pop_method_1, fig.width=8, fig.height=6}
ggplot(predict_df |>
           filter(her=="0.9", 
                  num_causals=="512", 
                  power=="-0.25"),
...
```{r scores_by_pop_method_2, fig.width=8, fig.height=6}
ggplot(predict_df |>
           filter(her=="0.9", 
                  num_causals=="512", 
                  power=="-1"),
...
```{r scores_by_her_method_1, fig.width=8, fig.height=6}
ggplot(predict_df |>
           filter(
...
```{r scores_by_her_method_2, fig.width=8, fig.height=6}
ggplot(predict_df |>
           filter(
               superpop %in% c("EUR"),
               num_causals=="512",
...
```{r scores_by_her_method_3, fig.width=8, fig.height=6}
ggplot(predict_df |>
           filter(
               superpop %in% c("EAS"),
               num_causals=="512",
...
```{r scores_by_numcausals_method_1, fig.width=8, fig.height=6}
ggplot(predict_df |>
           filter(
...
```{r scores_by_numcausals_method_2, fig.width=8, fig.height=6}
ggplot(predict_df |>
           filter(
               num_causals %in% c("1", "10", "100", "512"),
               superpop %in% c("EUR", "SAS"),
...
```{r scores_by_numcausals_method_3, fig.width=8, fig.height=6}
ggplot(predict_df |>
           filter(
               num_causals %in% c("1", "10", "100", "512"),
               superpop %in% c("EUR", "SAS"),
...
```{r scores_by_power_method_1, fig.width=8, fig.height=6}
ggplot(predict_df |>
           filter(
...
```{r scores_by_power_method_2, fig.width=8, fig.height=6}
ggplot(predict_df |>
           filter(
...
```{r result_by_her_method_1, fig.width=8, fig.height=6}
...
```{r result_by_her_method_2, fig.width=8, fig.height=6}
# colors <- c("Train" = RColorBrewer::brewer.pal(5, "Set1")[1], 
#             "Test" = RColorBrewer::brewer.pal(5, "Set1")[2])
ggplot(result_df |>
           filter(num_causals=="512",
...
```{r result_by_numcausal_method_1, fig.width=8, fig.height=6}
# colors <- c("Train" = RColorBrewer::brewer.pal(5, "Set1")[1], 
#             "Test" = RColorBrewer::brewer.pal(5, "Set1")[2])
ggplot(result_df |>
